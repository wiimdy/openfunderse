...
- Manual intent validation runbook: [`protocol/intent-manual-validation.md`](protocol/intent-manual-validation.md)
- Protocol conformance plan: [`protocol/conformance-plan-v1.md`](protocol/conformance-plan-v1.md)
- Hashing/EIP-712 reference: [`protocol/hashing-eip712-v1.md`](protocol/hashing-eip712-v1.md)
