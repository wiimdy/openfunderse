...
현재 경로:
- participant 봇이 claim/attestation 수행
...
4. Verifier bot이 claim attestation 제출.
5. Relayer가 claim finalize(기본 OFFCHAIN).
6. Relayer가 snapshot 생성/갱신.
...
- claim ONCHAIN 경로는 호환 모드(기본 운영 경로 아님).
